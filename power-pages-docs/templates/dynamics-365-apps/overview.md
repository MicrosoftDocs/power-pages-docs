...
- Dynamics 365 templates are not available during the first run experience for creation of a site. For subsequent site creation, Dynamics 365 templates are available.
