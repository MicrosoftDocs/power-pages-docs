...
When you enable the Web Application Firewall (WAF) for your Power Pages site, all [managed rules](/power-pages/security/web-application-firewall-rule-groups) are turned on by default.
