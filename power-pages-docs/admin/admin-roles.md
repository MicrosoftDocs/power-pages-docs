...
| [Set up Power BI integration](set-up-power-bi-integration.md) | <ul><li> [Global administrator](#global-administrator)</li><li>[Power Platform administrator](#power-platform-administrator)</li><li>See also: [Create security group and add to Power BI account](set-up-power-bi-integration.md#create-security-group-and-add-to-power-bi-account)</li></ul> |
