...
Advanced forms can be configured for different behaviors, set default values, and specialized user controls. In the following example, we'll replace a lookup column with dropdown control as it would provide a better experience for a user.
