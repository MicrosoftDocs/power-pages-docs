...
- Dynamics 365 templates are not available during the first run experience for creation of a site. Once the first run experience is complete, for subsequent site creation, Dynamics 365 templates would be available. 
