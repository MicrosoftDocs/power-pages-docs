...
Creating a Power Pages site no longer requires user-based permissions to register an app in Microsoft Entra. Power Pages uses a platform-managed identity to securely access Dataverse and related services. For more information about how Power Pages manages identity and authentication, see [Managed identity and site provisioning in Power Pages](../security/identity-provisioning.md).
