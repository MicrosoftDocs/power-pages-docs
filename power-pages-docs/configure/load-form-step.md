...
|                             Accept                             |                                                                                                                 The accept attribute specifies the MIME types of files that the server accepts through file upload. To specify more than one value, separate the values with a comma (for example, audio/\*,video/\*,image/\*).    MIME type support relies on browser compatibility. Any MIME type that is not recognized by the browser will not be supported.                                                                                                             |
