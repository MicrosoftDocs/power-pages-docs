...
- Power Pages don't support hidden choice values. More information: [Create a global choice within a solution](/power-apps/maker/data-platform/custom-picklists#create-a-global-choice-within-a-solution).
