...
1. Select + Create a site from the Home page as shown in the screenshot.

    ![](media/image1.png)

1. Choose the Default design template from the available options and click Next.

    ![](media/image2.png)

    ![](media/image3.png)

1. Validate the default site name and web address created. Note: you can edit these as needed. Click Done. The Power Pages takes a few minutes to provision your portal.

    ![](media/image4.png)

## Default template core elements

The Default design template consists of basic components that are essential building blocks of a website design. These components include -
...
Below are screenshots from the maker studio on the left and runtime representation of how the text component will look like in production on the right.

![](media/image5.png)![](media/image6.png)

### Button component

Button component allows maker to define call to action when a button is clicked on the site. The screenshot on the left shows how a button can be configured and styled in the maker studio and on the right shows how the button looks in production.

![](media/image7.png)![](media/image8.png)

### Image component

Image is one of the components that you can add within a section. In default design template you will find several image components used to make the site more aesthetic and pleasing to users. At any time, a make can edit these images in the maker studio and customize as needed.

See screenshot below to learn how to edit an image component in the Maker studio.

![](media/image9.png)

As the maker is making these changes, they get autosaved. Maker can view these changes at runtime by selecting Preview. Below is a screenshot of the site as to how it would look in production.
...
Screenshots below shows how form components can be edited in maker studio.

![](media/image11.png)![](media/image12.png)

If you would like to change the table or form (simple contact us form) to something else, you can make changes here and save them. Once everything looks good, the screenshot below shows how the form looks in runtime on the production site.

![](media/image13.png)

### Iframe component

Iframe component allows you to embed webpage of another website. In this template, by default the ifram URL is set to Bing maps. Screenshot on the left shows how its configured in the studio and on the right show how it looks on production site.

![](media/image14.png)![](media/image15.png)

### Video component

A video component allows maker to embed video as a content on the site. Below screenshot on the left shows how video component can be configured, in this template a video URL has been uploaded which can be easily edited and the screenshot on the right shows how the video will appear on the production site.
