...
> [!NOTE]
> Starting from Power Pages site version 9.7.1.34, default Forum Access Permission is disabled. Makers need to configure 'Restrict Read' to provide Forum Access Permission.
