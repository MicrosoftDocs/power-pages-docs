...
Advance to the next article to learn how to configure page permissions to allow or restrict access to pages in your site.
> [!div class="nextstepaction"]
> [Next steps](tutorial-setup-page-permissions.md)
