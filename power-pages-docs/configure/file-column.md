...
Create a new file data type column in [Dataverse](/power-apps/maker/data-platform/create-edit-field-portal#create-a-column#create-a-column) for a contact table with the name **myfileattribute**.
