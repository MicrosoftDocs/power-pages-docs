...
The entitylist object is used within the [Power Apps Dataverse table tags](dataverse-liquid-tags.md). It provides access to all the attributes of a given list.  
...
The searchindex object is used within the [Power Apps Dataverse table tags](dataverse-liquid-tags.md), and provides access to the results of a query.  
