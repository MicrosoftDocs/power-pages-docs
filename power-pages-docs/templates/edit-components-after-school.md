...
1. Select the local content and head to choose the advanced tab. You will see the custom JS JavaScript that's driving the page and you can make edits directly to the code.
...
1. you can change the active list and/or view being used, the view being used etc. from within the Mmaker Sstudio.
...
1. Head over to the portal management app and click into the website binding.
...
1. Once into the right website binding click into the website.
...
1. Click on related and select the Web Roles option.

![A graphical user interface displaying the Websites section of Maker Studio ](media/image32.png)

1. Click into the C1 ASP Web role once inside the webroles.
...
1. Click on add an existing contact and add the right contact into the C1 ASP role and save.
