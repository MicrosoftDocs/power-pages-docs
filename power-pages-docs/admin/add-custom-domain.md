...
Once you have the renewed (reissued) certificate .PFX file, to replace your old certificate click on the edit icon (pencil icon) beside your custom domain in [Power Portals admin center](https://admin.powerplatform.microsoft.com/resources/portals).

1. Upload your renewed certificate .pfx file by clicking on "New" in the Edit Custom Domain pane that opens up.
