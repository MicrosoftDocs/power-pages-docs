...
> [!NOTE]
> Starting from Power Pages site version 10.7.1.33, default forum access permission is disabled. Makers need to configure 'Restrict Read' to provide forum access.
