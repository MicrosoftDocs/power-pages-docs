...
Power Pages utilizes the Power Apps portals capabilities for authentication. View the full list here: [Overview of authentication in Power Apps portals](/power-apps/maker/portals/configure/configure-site) in the Power Apps portals documentation.
