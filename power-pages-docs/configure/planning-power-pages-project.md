...
Power Pages is a lot of fun so don’t stop exploring and creating. 
...
## Consider good strategies from Microsoft Power Apps 
...
Consider Azure Active Directory B2C  - this is Microsoft external identity provider. You can hook up same custom and corporate identity systems, and enable use of existing social accounts like Microsoft Account, LinkedIn, Google, etc.  <link> 

We support UI customization and have details on how to personalize the sign in and sing up experiences. <link>
