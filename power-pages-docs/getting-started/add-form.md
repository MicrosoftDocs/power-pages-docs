...
When you add a new form, you'll be prompted to set permissions to allow site users to interact with the form. The settings for Table permissions will be pre-set, but you'll still need to assign web roles and save the table permission settings. This process will also configure the permissions for attachments to be added to the records.
